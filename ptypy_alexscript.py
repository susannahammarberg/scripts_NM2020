...
#from ptypy.experiment.nanomax import NanomaxContrast

## simplest possible input #############################################
detector = 'merlin' # eiger or 'merlin' or 'pilatus'
...
p.scans.scan00.data.name = 'NanomaxFlyscanDec2019'#NanomaxContrast'
p.scans.scan00.data.path = folder
p.scans.scan00.data.detector = detector
p.scans.scan00.data.maskfile = {'merlin': None, #'/data/visitors/nanomax/common/masks/merlin/latest.h5',
								'pilatus': None,
                                'eiger': None,}[detector]
...
p.engines.engine00.numiter = 2#100
p.engines.engine00.numiter_contiguous = 10

p.engines.engine01 = u.Param()
p.engines.engine01.name = 'ML'
p.engines.engine01.numiter = 1# 100
