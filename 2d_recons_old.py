...
scannr = 443 # 397#     try 467 för inP
distance = 1.0
energy = 10
########################################################################
...
# TODO should be the bragg angle. Or -bragg angle? "Angle of the motor x axis relative to the lab x axis"
p.scans.scan00.data.xMotorAngle = 8.8# 
p.scans.scan00.data.shape = 170#170#256#128
p.scans.scan00.data.save = None
p.scans.scan00.data.center = (148, 345)  # innan (148, 364)# InPx364 GaInPx155 #None # auto, you can also set (i, j) center here.
...
##p.scans.scan00.illumination.aperture.size = 180e-9 # 210e-9 #500
##
...
#made a new recon with shape 170x170. its this one
...
##Sprobe = Cprobe.new_storage(psize=psize, shape=(loaded_profile.shape[-1]))
...
##p.engines.engine00.probe_update_start = 1000
