...
# InP tighter range
#scans = np.arange(429,460+1).tolist()
...
# do need this to save dumps i think
...
p.scans.scan01.data.theta_bragg = 10.54 # for InP according from table value. If that is correct, I dont need 2theta.       #11.5 #inP? 
...
p.scans.scan01.data.orientation = (False, False, True)# None# 4+1+2#None
...
p.scans.scan01.sample.fill = 1E-9# 1e-3 ########################OBS this fields the whole of z, not just were the views are active. maybe try to add this after level 2
...
##p.engines.engine00.sample_support.size = 300e-9   #diameter. No support for long axis. 
